...
<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <!-- Payment Settings -->
    <a href="{{ route('admin.settings.payment') }}" class="bg-white border border-slate-200 p-6 hover:border-slate-400 transition-colors group">
        <div class="w-12 h-12 bg-slate-100 flex items-center justify-center mb-4 group-hover:bg-slate-900 transition-colors">
            <svg class="w-6 h-6 text-slate-600 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
        </div>
        <h3 class="text-[11px] font-bold tracking-[0.15em] uppercase text-slate-500 mb-2">Payment Settings</h3>
        <p class="text-[13px] text-slate-600">Payment gateway, tax, currency settings</p>
    </a>
</div>
@endsection
