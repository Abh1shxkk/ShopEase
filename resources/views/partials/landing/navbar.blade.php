                        ...
                        <div x-show="open"
                            ...
                            <div class="bg-white rounded-lg border border-slate-200 shadow-xl min-w-[200px] overflow-hidden">
                                ...
                                <div class="py-1">
                                    ...
                                    @if(auth()->user()->seller)
                                    <a href="{{ route('seller.dashboard') }}" class="flex items-center gap-2 px-4 py-2 text-[11px] text-indigo-700 hover:bg-indigo-50">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                                        Seller Dashboard
                                    </a>
                                    @else
                                    <a href="{{ route('seller.register') }}" class="flex items-center gap-2 px-4 py-2 text-[11px] text-indigo-700 hover:bg-indigo-50">
                                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                                        Become a Seller
                                    </a>
                                    @endif
