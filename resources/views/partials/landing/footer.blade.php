    ...
    <div class="max-w-[1440px] mx-auto px-6 md:px-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
            ...
            <div class="md:col-span-1">
                ...
                <div class="flex gap-6 mt-8">
                    {{-- Instagram --}}
                    <a href="#" class="hover:text-slate-500 transition-colors" target="_blank" rel="noopener">
            ...
            <div class="grid grid-cols-2 gap-8 md:col-span-2">
                <div>
                    ...
                    <ul class="space-y-4 text-[12px]">
                        <li><a href="{{ route('shop.index', ['category' => 'Women']) }}" class="hover:underline">Women</a></li>
                        <li><a href="{{ route('shop.index', ['category' => 'Men']) }}" class="hover:underline">Men</a></li>
                        <li><a href="{{ route('shop.index', ['category' => 'Accessories']) }}" class="hover:underline">Accessories</a></li>
        ...
        <div class="pt-12 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div class="flex gap-4 grayscale opacity-50">
                ...
                <div class="w-10 h-6 bg-slate-100 border border-slate-200 flex items-center justify-center text-[8px] font-bold">PP</div>
            </div>
